...
There is a counterargument: perhaps efficiency improvements will outpace demand growth. Algorithmic advances like mixture-of-experts, quantisation, and distillation have dramatically reduced the compute (and therefore energy) needed for inference. New chip architectures achieve more operations per watt with each generation. Some researchers argue that the energy crisis is a temporary bottleneck that engineering will solve within a few years.
